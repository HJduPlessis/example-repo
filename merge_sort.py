...
str_list1 = ["banana", "apple", "cherry", "date", "fig", "grape", "kiwi", "lemon", "mango", "nectarine"];
str_list2 = ["orange", "papaya", "quince", "raspberry", "strawberry", "tangerine", "ugli fruit", "vanilla bean", "watermelon", "xigua"];
str_list3 = ["yellow passion fruit", "zucchini", "apricot", "blackberry", "cantaloupe", "dragon fruit", "elderberry", "feijoa", "grapefruit", "honeydew melon"];

print(f'list1: {long_to_short_merge(str_list1)}')
print(f'list2: {long_to_short_merge(str_list2)}')
print(f'list3: {long_to_short_merge(str_list3)}')
